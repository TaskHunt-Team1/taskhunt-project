/*
"في البداية بعمل اتصال بقاعدة البيانات SQLite باستخدام مكتبة better-sqlite3،
 ولو ملف قاعدة البيانات مش موجود بيتعمل تلقائياً باسم taskhunt.db."
*/
...
module.exports = db;
/*
"في النهاية بعمل تصدير (Export) لكائن قاعدة البيانات،
 بحيث أقدر أستخدم نفس الاتصال في جميع ملفات الـ Backend بدل ما أفتح اتصال جديد كل مرة."
*/
/*
"لأن المشروع مشروع تخرج بحجم متوسط، وSQLite قاعدة بيانات خفيفة ولا تحتاج إلى Server منفصل. 
استخدمنا مكتبة better-sqlite3 لأنها سريعة، سهلة في الاستخدام مع Node.js، وتوفر تنفيذًا مباشرًا للاستعلامات 
(Synchronous)، فكانت مناسبة للمشروع."
*/
